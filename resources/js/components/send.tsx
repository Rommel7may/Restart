...
export default function StudentIndex() {
  ...
  const handleSubmitStudent = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err)
      toast.error("Email or Student number has already been taken.")
    }
  }
  ...
  return (
    <div className="w-full">
        ...
        <DialogContent>
          ...
          <form onSubmit={handleSubmitStudent} className="space-y-4">
            ...
            <select
              ...
              required
              className="w-full rounded-md border border-black px-3 py-2 text-sm dark:border-white dark:bg-black dark:text-white focus-visible:ring-1 focus-visible:ring-black dark:focus-visible:ring-white"
            >
      ...
      {/* ✅ Place modal here, outside of Dropdown */}
      <DeleteStudentModal
