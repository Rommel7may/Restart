    ...
    public function update(Request $request, $student_number)
    {
        ...
        $validated = $request->validate([
            'email' => [
                'required',
                'email',
                Rule::unique('alumni', 'email')->ignore($alumni->id), // ✅ Ignores self
            ],
            'program_id' => 'required|exists:programs,id', // ✅ Correct field name
            ...
            'active_email' => [
                'required',
                'email',
                Rule::unique('alumni', 'active_email')->ignore($alumni->id), // ✅ Ignores self
            ],
